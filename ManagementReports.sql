...
CREATE 
OR ALTER VIEW [dbo].[FreeToPremium] AS
SELECT
...
(
    ...
    FROM
        [dbo].[Cliente]
        inner join [dbo].[Assinatura] ON [dbo].[Cliente].ClienteId = [dbo].[Assinatura].ClienteId
    WHERE
...
CREATE 
OR ALTER VIEW [dbo].[RenewedPremiumCustomers] AS
SELECT
    [dbo].[Cliente].ClienteId,
    [dbo].[Cliente].NomeCompleto,
    [dbo].[Cliente].Email
...
CREATE
OR ALTER VIEW [dbo].[NonRenewedPremiumCustomers] AS
SELECT
    [dbo].[Cliente].ClienteId,
    [dbo].[Cliente].NomeCompleto,
    [dbo].[Cliente].Email
...
CREATE
OR ALTER VIEW [dbo].[SubscriptionsExpiring30Days] AS
SELECT
    [dbo].[Cliente].NomeCompleto,
    [dbo].[Cliente].Email,
